      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center mb-24">
          ...
          <motion.div
            ...
            className="h-[400px] lg:h-[500px] bg-gradient-to-br from-grass/20 to-pitch border border-gold/20 flex items-center justify-center"
          >
            <span className="text-warm-gray italic text-lg">Visual Placeholder</span>
          </motion.div>
        </div>
