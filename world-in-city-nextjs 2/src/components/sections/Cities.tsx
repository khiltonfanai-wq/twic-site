        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {cities.map((city, index) => (
            <motion.div
              ...
              className="group relative bg-pitch border border-gold/10 p-12 overflow-hidden cursor-pointer hover:border-gold hover:-translate-y-3 hover:shadow-2xl hover:shadow-gold/20 transition-all duration-300"
            >
              {/* Hover gradient */}
